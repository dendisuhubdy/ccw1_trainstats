...
try:
    ...
    print(packageError)
```
The sample video here, is a demonstration video using curiosity method introduced [here](https://github.com/pathak22/noreward-rl) and the GIF file, is taken as a spatio-temporal features example, from the supplemental material tsken from [this link](http://cs.stanford.edu/people/karpathy/deepvideo/index.html). 
